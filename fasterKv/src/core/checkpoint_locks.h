...
struct CheckpointLock {
  CheckpointLock() : control_{0} {}
  CheckpointLock(uint64_t control) : control_{control} {}
...
class AtomicCheckpointLock {
 public:
  AtomicCheckpointLock() : control_{0} {}
...
class CheckpointLocks {
 public:
  CheckpointLocks() : size_{0}, locks_{nullptr} {}
  ...
  void Initialize(uint64_t size) {
    ...
    locks_ = reinterpret_cast<AtomicCheckpointLock*>(
        aligned_alloc(Constants::kCacheLineBytes, size_ * sizeof(AtomicCheckpointLock)));
